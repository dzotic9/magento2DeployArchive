...
RUN wget -q "https://github.com/dzotic9/magento2nginxphp/blob/master/archive.zip?raw=true" -O /var/www/webroot/ROOT/archive.zip;\
        ...
        yum -y install https://github.com/dzotic9/magento2nginxphp/blob/master/libmcrypt-2.5.8-13.el7.x86_64.rpm?raw=true;\
        yum -y install https://github.com/dzotic9/magento2nginxphp/blob/master/viber-4.2.2.6-8.el7.nux.x86_64.rpm?raw=true;\
        yum -y install https://github.com/dzotic9/magento2nginxphp/blob/master/libtidy-0.99.0-31.20091203.el7.x86_64.rpm?raw=true;\
        yum -y install https://github.com/dzotic9/magento2nginxphp/blob/master/libfbclient2-3.0.0.30573-11.1.x86_64.rpm?raw=true;
